...
(function(m) {
        ...
        C = function(a, c, b, k) {
            ...
            this.check = function(c) {
                ...
                if (0 === h && b) {
                    ...
                    k && ((m.GreenSockGlobals ||
                        m)[f] = j, "function" === typeof define && define.amd ? define((m.GreenSockAMDPath ? m.GreenSockAMDPath + "/" : "") + a.split(".").join("/"), [], function() {
                        return j
    ...
    var I = [0, 0, 1, 1],
        D = [],
        t = r("easing.Ease", function(a, c, b, k) {
            this._func = a;
            this._type =
                b || 0;
            this._power = k || 0;
    ...
    for (j = p.length; - 1 < --j;) d = r("easing." + p[j], null, !0), B = r("easing.Power" + j, null, !0), d.easeOut = B.easeOut = new t(null,
        null, 1, j), d.easeIn = B.easeIn = new t(null, null, 2, j), d.easeInOut = B.easeInOut = new t(null, null, 3, j);
    ...
    d.dispatchEvent = function(a) {
        ...
        if (c)
            for (var b = c.length, k = this._eventTarget, d; - 1 < --b;) d = c[b], d.up ? d.c.call(d.s || k, {
                type: a,
                target: k
            }) : d.c.call(d.s || k)
    };
    ...
    p = ["ms", "moz", "webkit", "o"];
    for (j = p.length; - 1 < --j && !y;) y = m[p[j] + "RequestAnimationFrame"], E = m[p[j] +
        "CancelAnimationFrame"] || m[p[j] + "CancelRequestAnimationFrame"];
    r("Ticker", function(a, c) {
        var b = this,
            k = K(),
            d = !1 !== c && y,
            g, i, f, h, n, j = function() {
    ...
    d.eventCallback = function(a, c, b, d) {
        ...
        if ("on" === a.substr(0,
            ...
            else if (this.vars[a] = c, this.vars[a + "Params"] = b, this.vars[a + "Scope"] = d, b)
                for (var e = b.length; - 1 < --e;) "{self}" === b[e] && (b = this.vars[a + "Params"] = b.concat(), b[e] = this);
    ...
    var h = r("TweenLite", function(a, c, b) {
        q.call(this, c, b);
        if (null ==
        ...
        if ((a instanceof Array || a.jquery) && "object" === typeof a[0]) {
            ...
            for (a = 0; a < this._targets.length; a++) b = this._targets[a], b.jquery ? (this._targets.splice(a--, 1), this._targets = this._targets.concat(b.constructor.makeArray(b))) : (this._siblings[a] =
                z(b, this, !1), 1 === this._overwrite && 1 < this._siblings[a].length && F(b, this, null, 1, this._siblings[a]))
    ...
    var z = function(a, c, b) {
            var d = a._gsTweenID,
                e;
            if (!v[d || (a._gsTweenID = d = "t" + O++)]) v[d] = {
                target: a,
                tweens: []
            };
            if (c && (a = v[d].tweens, a[e = a.length] = c, b))
        ...
        F = function(a, c, b, d, e) {
            ...
            var h = c._startTime + 1E-10,
                ...
                m;
            for (g = e.length; - 1 < --g;)
                if (!((f = e[g]) === c || f._gc || f._paused)) f._timeline !==
                    c._timeline ? (m = m || N(c, 0, l), 0 === N(f, m, l) && (n[j++] = f)) : f._startTime <= h && f._startTime + f.totalDuration() / f._timeScale + 1E-10 > h && ((l || !f._initted) && 2E-10 >= h - f._startTime || (n[j++] = f));
            for (g = j; - 1 < --g;)
                if (f = n[g], 2 === d && f._kill(b, a) && (i = !0), 2 !== d || !f._firstPT && f._initted) f._enabled(!1, !1) && (i = !0);
            return i
        },
        N = function(a, c, b) {
    ...
    d._init = function() {
        ...
        var a, c;
        this._ease = this.vars.ease instanceof t ? this.vars.easeParams instanceof Array ? this.vars.ease.config.apply(this.vars.ease, this.vars.easeParams) : this.vars.ease : "function" === typeof this.vars.ease ? new t(this.vars.ease, this.vars.easeParams) : h.defaultEase;
        ...
        for (e in this.vars) {
            if (P[e]) {
                if ("onStartParams" === e || "onUpdateParams" === e || "onCompleteParams" === e || "onReverseCompleteParams" === e || "onRepeatParams" === e)
                    if (h = this.vars[e])
                        for (g = h.length; - 1 < --g;) "{self}" === h[g] && (h = this.vars[e] = h.concat(), h[g] = this)
                ...
                if (f._onDisable || f._onEnable) this._notifyPluginsOfEnabled = !0
                    ...
                    pg: !1,
                    pr: 0
                }, j.s = !j.f ? parseFloat(a[e]) : a[e.indexOf("set") || "function" !== typeof a["get" + e.substr(3)] ? e : "get" + e.substr(3)](), g = this.vars[e], j.c = "number" === typeof g ? g - j.s : "string" === typeof g && "=" === g.charAt(1) ?
                parseInt(g.charAt(0) + "1") * Number(g.substr(2)) : Number(g) || 0;
    ...
    d.render = function(a, c, b) {
        ...
        if (a >= this._duration) {
            if (this._totalTime = this._time = this._duration, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (e = !0, g = "onComplete"), 0 === this._duration) {
                if (0 === a || 0 >
                    this._rawPrevTime) this._rawPrevTime !== a && (b = !0);
                this._rawPrevTime = a
            }
        } else if (0 >= a) {
    ...
    d._kill = function(a, c) {
        ...
        if ((c instanceof Array || c.jquery) && "object" === typeof c[0])
            for (b = c.length; - 1 < --b;) this._kill(a, c[b]) && (h = !0);
        else {
            if (this._targets)
            ...
            if (g)
                for (e in f =
                    a || g, j = a != d && "all" != d && a != g && (null == a || !0 != a._tempKill), f) {
                    if (b = g[e]) {
    ...
    d._enabled = function(a, c) {
        if (a && this._gc)
            if (this._targets)
                for (var b = this._targets.length; - 1 < --b;) this._siblings[b] = z(this._targets[b], this, !0);
    ...
    var A = r("plugins.TweenPlugin", function(a, c) {
