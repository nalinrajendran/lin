function setMenu() {
    ...
    if (!isTouch) {
        ...
        $(creation).bind("mouseover", mouseOver2);
        $(creation).bind("mouseout", mouseOut2);
        $(creation).bind("click", click2);
...
function clickTouch1(e) {
    ...
    if (dist == 1 && siteVersion == 2) tl.to(Scroller, dist * 1.5, {
        targetYTmp: 0 + pos * 200 * BMSite.siteScale,
        ease: SlowMo.ease,
        onUpdate: updateTargetScroll
    });
...
function clickTouch2(e) {
    ...
    if (dist == 1 && siteVersion == 2) tl.to(Scroller, dist * 1.5, {
        targetYTmp: (where + pos * 200) * BMSite.siteScale,
        ease: SlowMo.ease,
        onUpdate: updateTargetScroll
    });
    tl.to(Scroller, dist * 0.5, {
        targetYTmp: where * BMSite.siteScale,
        ease: Power4.easeOut,
        onUpdate: updateTargetScroll
    })
}
...
function clickTouch6(e) {
    ...
    TweenLite.to(Scroller, 0.5 * dist, {
        targetYTmp: where * BMSite.siteScale,
        overwrite: "all",
        ease: Power4.easeOut,
        onUpdate: updateTargetScroll
...
function click1(e) {
    ...
    if (dist == 1) tl.to(window, dist * 1.5, {
        scrollTo: {
            y: BMSite.currentScrollY + pos * 200
        },
        ease: SlowMo.ease,
        onUpdate: scrollSpecialUseClick
    });
    tl.to(window, dist * 0.5, {
        scrollTo: {
            y: BMSite.currentScrollY
...
function click6(e) {
    ...
    if (BMSite.clickSnd !=
        null) createjs.Sound.play("click", "none", 0, 0, 0, 0.5)
}
...
function clickContact(e) {
    ...
    if (BMSite.clickSnd != null) createjs.Sound.play("click",
        "none", 0, 0, 0, 0.5)
}
...
function clickContactTouch(e) {
    ...
    if (dist == 0) dist = 0.5;
    Scroller.targetYUpdateTmp();
    TweenLite.to(Scroller, 1.5 * dist, {
        targetYTmp: 7306 * BMSite.siteScale,
        overwrite: "all",
        ease: Power4.easeOut,
...
function clickSound(e) {
    ...
    if (BMSite.soundOff == false) {
        ...
        if (BMSite.lang == "PL") TweenLite.to(soundCont, 0.3, {
            css: {
                "width": 78
            }
        });
        else TweenLite.to(soundCont, 0.3, {
            css: {
                "width": 66
            }
        });
        TweenLite.to(soundLoop, 1, {
            volume: 0,
